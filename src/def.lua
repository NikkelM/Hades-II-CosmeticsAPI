...
---@field Name table The display name of the cosmetic. Provide a table for localized names in the format of { de = "German Name", el = "Greek Name", en = "English Name", ... }. Any missing languages will fall back to English.
---@field FlavorText table The description text for the cosmetic. Prefix with "{$Keywords.CosmeticAltAdd}:" for Alt Decor, and "{$Keywords.CosmeticAdd}:" for Extra Decor. Provide a table for localized names in the format of { de = "German Description", el = "Greek Description", en = "English Description", ... }. Any missing languages will fall back to English.
...
---@field InsertAfterCosmeticInCategory string|nil The ID of an existing cosmetic in the same ShopCategory to insert this cosmetic after. If nil, the cosmetic will be added to the end of the category.
---@field Icon string The path to the shop menu icon for the cosmetic. Usually has a resolution of 125x125 or 110x110.
---@field SetAnimationValue string The path to the asset texture for this cosmetic.
...
---@field RemoveCosmetics string Which group of cosmetics to remove/replace this cosmetic with when equipped. Must be the ID of an existing cosmetic in the same ShopCategory. This cosmetic will be added to the same group, or create a group if none exists yet.
...
---@field OnRevealFunctionName string|nil The name of a function to call after the cosmetic is revealed, but before the camera pans back to Melinoe.
-- ---@field RotateOnly boolean|nil If true, indicates this cosmetic is part of a group of other cosmetics (an "Alt Decor"). If false, indicates this is an "Extra Decor" cosmetic. Defaults to true. Must be true if RemoveCosmeticsGroup is set. Not used for the API.
...
-- ---@field Removable boolean|nil If true, indicates this cosmetic can be removed again after buying it. If false, this cosmetic will always be visible in the Crossroads once bought. Defaults to true. Can only be set to false for cosmetics not part of a group through RemoveCosmetics. Not used in the API/always set to true.
